...
<body class="hold-transition skin-green sidebar-mini">
					...
					<form class="form-horizontal" id="add-category-form">
						<div class="box-body">
							<div class="form-group">
								<label for="code" class="col-lg-2 control-label">Mã danh mục</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="cd" name="cd" placeholder="Mã danh mục" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="name" class="col-lg-2 control-label">Tên danh mục</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="name" name="name" placeholder="Tên danh mục" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="description" class="col-lg-2 control-label">Mô tả</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="description" name="description" placeholder="Mô tả" readonly>
								</div>
							</div>
						</div><!-- /.box-body -->
					</form>
	...
	<jsp:include page="category-detail-js.jsp"></jsp:include>
</body>