...
<body class="hold-transition skin-green sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-success">
					...
					<div class="box-footer">
						<button id="btnBack" class="btn btn-default">Trở về</button>
						<button id="btnSave" class="btn btn-success">Lưu chỉnh sửa</button>
					</div>
					<!-- /.box-footer -->
				</div>
			</section>
	...
	<jsp:include page="update-category-js.jsp"></jsp:include>
