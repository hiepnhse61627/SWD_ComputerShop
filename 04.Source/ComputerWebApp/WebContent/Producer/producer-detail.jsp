...
<body class="hold-transition skin-green sidebar-mini">
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>Thông tin nhà cung cấp</h1>
			</section>
					...
					<form class="form-horizontal" id="add-producer-form">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerCd" name="producerCd" placeholder="Mã nhà cung cấp" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="name" class="col-lg-2 control-label">Tên nhà cung cấp</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerName" name="producerName" placeholder="Tên nhà cung cấp" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="description" class="col-lg-2 control-label">Mô tả</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerDescription" name="producerDescription" placeholder="Mô tả" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="email" class="col-lg-2 control-label">Email</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerEmail" name="producerEmail" placeholder="Email" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="address" class="col-lg-2 control-label">Địa chỉ</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerAddress" name="producerAddress" placeholder="Địa chỉ" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="phone" class="col-lg-2 control-label">Số điện thoại</label>
								<div class="col-lg-5">
									<input type="text" class="form-control" id="producerPhone" name="producerPhone" placeholder="Số điện thoại" readonly>
								</div>
							</div>
						</div><!-- /.box-body -->
					</form>
					<div class="box-footer">
						<button id="btnBack" class="btn btn-success pull-left">Trở về</button>
					</div>
					<!-- /.box-footer -->
				</div>
			</section>
	...
	<jsp:include page="producer-detail-js.jsp"></jsp:include>
